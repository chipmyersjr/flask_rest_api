...
from customer.api import CustomerAPI, CustomerCountAPI, CustomerAddressAPI, CustomerLogin, CustomerLogOut\
    , CustomerEmailAPI, CustomerSnapshotAPI, CustomerSendConfirmation, CustomerConfirmAPI
...
customer_confirm_view = CustomerConfirmAPI.as_view('customer_confirm_api')
...
customer_app.add_url_rule('/customer/confirm/<token>', view_func=customer_confirm_view
                          , methods=["GET", ])