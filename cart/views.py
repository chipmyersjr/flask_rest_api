...
cart_app.add_url_rule('/customer/<customer_id>/cart/item/<product_id>', view_func=cart_item_view, methods=["POST", ])
cart_app.add_url_rule('/customer/<customer_id>/cart/item', view_func=cart_item_view, methods=["POST", ])